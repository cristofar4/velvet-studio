...
/* ─────────────────────────────────────────────────────────────
   All imagery & footage is royalty-free from Pexels
   (cottonbro studio, RDNE Stock project et al.) — hotlinked via
   the Pexels CDN. No placeholders.
   ───────────────────────────────────────────────────────────── */
...
/* Hero footage — cottonbro studio's barbershop series on Pexels.
   Source order = graceful fallback chain for the <video> element. */
...
/* Ambient loop behind the booking panel — “Barber · fades”. */
...
export const about = {
  ...
  imagePrimary: { src: pexels(8218487, 1400), alt: "Velvet Fade Studio lounge — leather chairs and warm brass lighting" },
  imageSecondary: { src: pexels(3998417, 1000), alt: "Master barber sculpting a client's beard line" },
...
export const services: Service[] = [
  {
    ...
    price: 55,
    duration: "45 min",
    features: ["Consultation & mapping", "Straight-razor edge-up", "Styling & product lesson"],
    image: pexels(15659486, 1100),
  },
  {
    id: "beard-sculpting",
...
export const barbers: Barber[] = [
  ...
  },
  {
    id: "leo-fontaine",
    name: "Leo Fontaine",
    role: "Classic Cuts & Grooming",
    years: 8,
    bio: "Old-school discipline, editorial eye. Leo finishes every cut like it's headed to a runway.",
    specialties: ["Pompadours", "Executive Cuts"],
    image: pexels(7781848, 1000),
    socials: [
      { label: "Instagram", href: "https://instagram.com" },
      { label: "TikTok", href: "https://tiktok.com" },
    ],
...
const galleryDefs: Array<[number, string, string, string]> = [
  ...
  [8218487, "The studio floor — leather, brass and mirrors", "The floor at dusk", "aspect-[4/3]"],
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    avatar: pexels(15361048, 400),
  },
  {
    name: "Sam Whitfield",
    title: "Photographer",
    quote:
      "The lighting, the vinyl, the espresso — it's a film set that happens to give the sharpest fade in SoHo. I shoot half my portfolio here.",
    rating: 4.5,
    avatar: pexels(6724917, 400),
  },
  {
    name: "Elias Branch",
    title: "Founder, Branch & Co.",
    quote:
